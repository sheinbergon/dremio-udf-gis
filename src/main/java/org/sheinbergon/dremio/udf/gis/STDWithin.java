...
public class STDWithin implements SimpleFunction {
  ...
  @Param(constant = true)
  org.apache.arrow.vector.holders.Float8Holder distanceInput;
  ...
  public void eval() {
    if (org.sheinbergon.dremio.udf.gis.util.GeometryHelpers.areHoldersSet(binaryInput1, binaryInput2)) {
      ...
      org.sheinbergon.dremio.udf.gis.util.GeometryHelpers.setBooleanValue(output, geom1.distance(geom2) <= distance);
    } else {
